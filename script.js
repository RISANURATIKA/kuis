    ...
    htmlContent += `
        ...
        <div class="pdf-footer">
            ...
            <div class="pdf-suggestion">
                <h3>Saran:</h3>
                <p>Anda dapat melakukan teknik relaksasi untuk mengurangi kecemasan dengan cara:</p>
                <ul>
                    <li>Mengambil nafas panjang.</li>
                    <li>Tahan selama 4 detik.</li>
                    <li>Buang nafas secara perlahan.</li>
                </ul>
                <p>Teknik ini dapat dilakukan sebanyak mungkin sampai kecemasan yang Anda rasakan mereda. Jika kecemasan yang dirasa tidak kunjung membaik, Anda dapat segera berkonsultasi kepada Psikiater.</p>
                
                <div class="contact-info">
                    <p><strong>Saat ini RS Wates Husada sudah mempunyai layanan pemeriksaan kesehatan jiwa dengan dr. Ayu Nuzulia Putri, Sp.KJ pada jadwal:</strong></p>
                    <ul>
                        <li>Hari Senin, 15.00 - 17.00</li>
                        <li>Hari Kamis, 15.00 - 17.00</li>
                    </ul>
                    <p>Pendaftaran konsultasi dengan dr. Ayu silahkan menghubungi nomer dibawah ini:<br>
                    <strong>0895334988885</strong></p>
                </div>
            </div>
        </div>
    `;
